...
[i:ci]: https://img.shields.io/github/actions/workflow/status/dr-js/imagemin-min/.github/workflows/ci-on-tag.yml
[l:ci]: https://github.com/dr-js/imagemin-min/actions?query=workflow:ci-on-tag
